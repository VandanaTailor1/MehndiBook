...
public class HotCircleAdapter extends RecyclerView.Adapter<HotCircleAdapter.RecycleManagerSelect> {
    Context context;
    ...
    public RecycleManagerSelect onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_hot_circle,parent,false);
